...
import cn.zy.apps.demo.service.units.ProjectMonthInvestmentPlanCompleteUnits ;
...
public class ProjectMonthInvestmentPlanServiceImple extends ABCommonsService implements IProjectMonthInvestmentPlanService {
    ...
    @Autowired
    @Qualifier("ProjectMonthInvestmentPlanCompleteUnits")
    private ProjectMonthInvestmentPlanCompleteUnits projectMonthInvestmentPlanCompleteUnits ;
    ...
    public SelectPage<ProjectMonthInvestmentPlan> search(OptType optType, ProjectMonthInvestmentPlanSearchBean searchBean, CommSearchBean commSearchBean, int... startLimit) throws SystemOptServiceException {
        return iProjectMonthInvestmentPlanSearchUnits.search(optType, searchBean, commSearchBean, startLimit) ;
    }

    @Override
    public List<ProjectMonthInvestmentPlan> searchList(OptType optType, ProjectMonthInvestmentPlanSearchBean searchBean, CommSearchBean commSearchBean, int... startLimit) throws SystemOptServiceException {

        return iProjectMonthInvestmentPlanSearchUnits.list(optType, searchBean, commSearchBean, startLimit) ;
    ...
    public ProjectMonthInvestmentPlan complete(Integer id) throws SystemOptServiceException {
        ...
        return projectMonthInvestmentPlanCompleteUnits.complete(id) ;
    }
