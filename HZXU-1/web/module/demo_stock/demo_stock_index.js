function create_demo_stock_window(moduleId, moduleName) {
	...
	var mainGridModule = new mainGridWindow({
		moduleId : moduleId,
		// list grid
		url : "./list_DemoStock_list.do",
		// grid_column.record
		record : demo_stock_grid_column.record,
		// grid_column.column
		column : demo_stock_grid_column.column,
		tbar : {
			...
			items : [{
				...
				handler : function(bt) {
					demo_stock_create_windows(moduleId, moduleName, {
						grid : mainGridModule
						,
				...
				handler : function(bt) {
					demo_stock_update_windows(moduleId, moduleName, {
						grid : mainGridModule
						,
				...
				handler : function(bt) {
					demo_stock_delete_windows(moduleId, moduleName, {
						grid : mainGridModule
						,
					});
				}
				...
				handler : function() {
					var searchWindex = demo_stock_search_windows(moduleId, moduleName, {
						grid : mainGridModule,
						searchParams : demo_stock_search_params
					});
				}
			}]
	...
	// var detailModule = new create_demo_stock_detail_window(moduleId +
	// "_detail", "明细", {
	// mainGrid : mainGrid
	// });
	...
	function demo_stock_delete_windows(moduleId, moduleName, params) {
		...
		showMsgYN({
			...
			yes : function(YN) {
				ERPAjaxRequest({
					url : "./simple_DemoStock_remove.do",
					params : {
