function create_project_type_window(moduleId, moduleName) {
	...
	var mainGridModule = new mainGridWindow({
		moduleId : moduleId,
		// list grid
		url : "./list_ProjectType_list.do",
		// grid_column.record
		record : project_type_grid_column.record,
		// grid_column.column
		column : project_type_grid_column.column,
		tbar : {
			...
			items : [{
				...
				handler : function(bt) {
					project_type_create_windows(moduleId, moduleName, {
					grid : mainGridModule,
				...
				handler : function(bt) {
					 project_type_update_windows(moduleId, moduleName, {
					 grid : mainGridModule,
			...
			// id : moduleId + '_delete',
				...
				handler : function(bt) {
					  project_type_delete_windows(moduleId, moduleName, {
					 grid : mainGridModule,
					 });
				}
			}, 
...
//				handler : function() {
//					var searchWindex = project_type_search_windows(moduleId, moduleName, {
//					grid : mainGridModule,
//					searchParams: project_type_search_params
//					});
//				}
//			}
			]
	...
	/**
	var detailModule = new create_project_type_detail_window(moduleId + "_detail", "明细", {
		mainGrid : mainGrid
	});
...
**/
	...
	mainGrid.load({
	  params:{
		...
		function   project_type_delete_windows(moduleId, moduleName, params) {
	...
	var selectId = selection_rows[0].id;
		showMsgYN({
			...
			yes : function(YN) {
				ERPAjaxRequest({
					url : "./simple_ProjectType_remove.do",  
					params : {
