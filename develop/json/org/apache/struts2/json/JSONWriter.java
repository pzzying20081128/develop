...
public class JSONWriter {
    ...
    protected void bean(Object object) throws JSONException {
        ...
        try {
            ...
            info = ((object == this.root) && this.ignoreHierarchy) ? getBeanInfoIgnoreHierarchy(clazz) : getBeanInfo(clazz) ;
...
//            }
    ...
    private Method search(Class clazz_, String name, Class<?>... parameterTypes) {
        try {
            Method baseAccessor = clazz_.getMethod(name, parameterTypes) ;
            return baseAccessor ;
    ...
    protected void array(Iterator it, Method method) throws JSONException {
        // ////System.out.println("============ array(Iterator it ====================== >   "+it.getClass());
        this.add("[") ;
        boolean hasData = false ;
