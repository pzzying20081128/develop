...
public class SMDMethod implements Comparable {
    ...
    public int compareTo(Object o) {
        ...
        if (name.equals(other.name)) return parameters.size() - other.parameters.size() ;

        return name.compareTo(other.name) ;
    }

    public boolean equals(Object obj) {
        if (!(obj instanceof SMDMethod)) return false ;
        SMDMethod toCompare = (SMDMethod) obj ;
        if ((name == null) && (toCompare.name == null)) return true ;
