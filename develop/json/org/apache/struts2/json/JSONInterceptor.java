...
public class JSONInterceptor extends AbstractInterceptor {
    ...
    public String intercept(ActionInvocation invocation) throws Exception {
        ...
        if (contentType != null) {
            int iSemicolonIdx ;
            if ((iSemicolonIdx = contentType.indexOf(";")) != -1) contentType = contentType.substring(0, iSemicolonIdx) ;
        }
        ...
        if ((contentType != null) && contentType.equalsIgnoreCase("application/json")) {
            ...
            if (obj instanceof Map) {
                ...
                // clean up the values
                if (dataCleaner != null) dataCleaner.clean("", json) ;
            ...
            JSONUtil.writeJSONToResponse(new SerializationParams(response, this.defaultEncoding, this.wrapWithComments, json, true, writeGzip, noCache, -1, -1, prefix, "application/json")) ;
    ...
    public RPCResponse invoke(Object object, Map data) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException, JSONException, InstantiationException, NoSuchMethodException, IntrospectionException {
        ...
        if (parameterCount > 0) {
            ...
            for (int i = 0; i < parameters.size(); i++) {
                ...
                // clean up the values
                if (dataCleaner != null) parameter = dataCleaner.clean("[" + i + "]", parameter) ;
    ...
    protected String addCallbackIfApplicable(HttpServletRequest request, String json) {
        if ((callbackParameter != null) && (callbackParameter.length() > 0)) {
            ...
            if ((callbackName != null) && (callbackName.length() > 0)) json = callbackName + "(" + json + ")" ;
        }
        return json ;
    }
