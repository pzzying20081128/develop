 ...
 * perform any validation, so it must follow the 'validation' interceptor on the
 * stack.
 * </p>
 * 
 * <p>
 * This stack (defined in struts-default.xml) shows how to use this interceptor
 * with the 'validation' interceptor
 * </p>
 * 
 * <pre>
 ...
 * 
 * <p>
 * If the request has a parameter 'struts.validateOnly' execution will return
 * after validation (action won't be executed).
 * </p>
 * 
 * <p>
 * A request parameter named 'struts.enableJSONValidation' must be set to 'true'
 * to use this interceptor
 * </p>
 * 
 * <p>
 * If the request has a parameter 'struts.JSONValidation.set.encoding' set to
 * true the character encoding will NOT be set on the response - is needed in
 * portlet environment - for more details see issue WW-3237
 * </p>
 */
    ...
    protected String buildResponse(ValidationAware validationAware) {
        ...
        if (validationAware.hasErrors()) {
            ...
            if (validationAware.hasFieldErrors()) {
                if (validationAware.hasActionErrors()) sb.append(",") ;
