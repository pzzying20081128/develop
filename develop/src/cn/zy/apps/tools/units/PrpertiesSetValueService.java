...
public abstract class PrpertiesSetValueService {
    ...
    private void simpleObject(Object result, Object parent) {
        if (result == null || !vpackage(result.getClass())) return ;
        ...
        for (PropertyDescriptor propertyDescriptor : propertyDescriptors) {
            ...
            if (propertyDescriptor.getReadMethod().getReturnType().equals(Set.class) || propertyDescriptor.getReadMethod().getReturnType().equals(List.class)) {
                ...
                try {
                    ...
                    if (objs == null || objs.getClass().toString().contains("$$_javassist_") || objs.getClass().toString().contains("_$$_jvst")) {
                ...
                try {
                    ...
                    if (fieldName.contains("$$_javassist_") || fieldName.contains("_$$_jvst")) continue ;
