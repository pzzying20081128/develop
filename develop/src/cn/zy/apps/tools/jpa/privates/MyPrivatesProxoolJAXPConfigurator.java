 ...
 * The parser relies on JAXP version 1.1 or higher and is namespace aware.
 * <p>
 * See {@link XMLConfigurator} for the Proxool xml configuration format.
 * </p>
 * <p>
 * All the <code>configure</code> methods of this class takes a boolean argument
 * describing whether the xml should be validated or not. If you want your xml
 * to be validated be sure to read the <a
 * href="XMLConfigurator.html#validation">Validation</a> chapter in the JavaDoc
 * for {@link XMLConfigurator}.
 * </p>
 * 
 ...
 * @since Proxool 0.6
 */
public class MyPrivatesProxoolJAXPConfigurator {
	private static final Log LOG = LogFactory.getLog(MyPrivatesProxoolJAXPConfigurator.class);
	 ...
	 * @param validate
	 *            <code>true</code> if the parsel shall be validating, and
	 ...
	 * 
	 * @param inputSource
	 *            the InputSource to read xml from.
	 * @param validate
	 *            <code>true</code> if the parsel shall be validating, and
	 *            <code>false</code> otherwise.
	 * @throws ProxoolException
	...
	public static void configure(InputSource inputSource, boolean validate) throws ProxoolException {
		try {
			...
			final MyPrivatesProxoolXMLConfigurator xmlConfigurator = new MyPrivatesProxoolXMLConfigurator();
...
/*
 * Revision history: $Log: JAXPConfigurator.java,v $ Revision 1.12 2006/01/18
 * 14:39:58 billhorsman Unbundled Jakarta's Commons Logging.
 * 
 * Revision 1.11 2004/05/14 21:15:47 brenuart Fix type in method name
 * 
 * Revision 1.10 2003/03/10 23:43:15 billhorsman reapplied checkstyle that i'd
 * inadvertently let IntelliJ change...
 * 
 * Revision 1.9 2003/03/10 15:26:54 billhorsman refactoringn of concurrency
 * stuff (and some import optimisation)
 * 
 * Revision 1.8 2003/03/03 11:12:00 billhorsman fixed licence
 * 
 * Revision 1.7 2003/02/06 17:41:05 billhorsman now uses imported logging
 * 
 * Revision 1.6 2003/01/27 18:26:42 billhorsman refactoring of ProxyConnection
 * and ProxyStatement to make it easier to write JDK 1.2 patch
 * 
 * Revision 1.5 2002/12/18 23:31:57 chr32 Expanded doc.
 * 
 * Revision 1.4 2002/12/16 11:46:59 billhorsman checkstyle
 * 
 * Revision 1.3 2002/12/16 02:38:47 chr32 Updated to new driver-properties xml
 * format.
 * 
 * Revision 1.2 2002/12/15 19:43:11 chr32 Style fixes.
 * 
 * Revision 1.1 2002/12/15 18:49:55 chr32 Init rev.
 */