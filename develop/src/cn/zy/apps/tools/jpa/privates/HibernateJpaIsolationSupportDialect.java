...
public class HibernateJpaIsolationSupportDialect extends HibernateJpaDialect {
     ...
     * 
     */
    private static final long serialVersionUID = 2333875470732075696L ;
    private org.slf4j.Logger logger = LoggerFactory.getLogger(HibernateJpaIsolationSupportDialect.class) ;
