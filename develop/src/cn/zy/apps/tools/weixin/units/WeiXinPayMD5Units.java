...
import cn.zy.apps.tools.units.HttpMD5Prams ;
import cn.zy.apps.tools.units.ToolsUnitsException ;

public class WeiXinPayMD5Units {

    public static String buildParamsMd5(Map<String, String> params, String signKey) throws ToolsUnitsException {
        HttpMD5Prams httpMD5Prams = new HttpMD5Prams(null, "md5", "sign") ;
        return buildParamsMd5(params, httpMD5Prams, signKey, "utf8") ;
    }
...
//        System.out.println("==> >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>  " + text) ;
    ...
    public static String createMD5(String paramsUrl, String signKey, String input_charset) throws ToolsUnitsException {
        ...
        try {
            String urlParams = paramsUrl.trim() ;
